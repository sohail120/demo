...
import { FlippingPagesDirection } from "./components/flipper";
...
const _Controls = (props: ControlsProps) => {
  ...
  const handleAnimationDurationChange: ChangeEventHandler<HTMLInputElement> =
    useCallback(
      (event) => {
  ...
  const handleDirectionChange: ChangeEventHandler<HTMLSelectElement> =
    useCallback(
      (event) => {
  ...
  const handleDisableSwipeChange: ChangeEventHandler<HTMLInputElement> =
    useCallback(
      (event) => {
  ...
  const handlePerspectiveMultiplierChange: ChangeEventHandler<HTMLInputElement> =
    useCallback(
      (event) => {
  ...
  const handleSelectedChange: ChangeEventHandler<HTMLInputElement> =
    useCallback(
      (event) => {
  ...
  const handleShadowBackgroundChange: ChangeEventHandler<HTMLInputElement> =
    useCallback(
      (event) => {
  ...
  const handleSwipeLengthChange: ChangeEventHandler<HTMLInputElement> =
    useCallback(
      (event) => {
  ...
  const handleSwipeSpeedChange: ChangeEventHandler<HTMLInputElement> =
    useCallback(
      (event) => {
    ...
    <div className={classes.container}>
      ...
      <label>
        ...
        <input
          ...
          onChange={handleShadowBackgroundChange}
        ></input>
      </label>
      <label>
        {"Swipe length "}
        <input
          type="number"
          value={swipeLength}
          onChange={handleSwipeLengthChange}
        ></input>
      </label>
      <label>
        {"Swipe speed "}
        <input
          type="number"
          value={swipeSpeed}
          onChange={handleSwipeSpeedChange}
        ></input>
      </label>
      <label>
        {"Swipe turn "}
